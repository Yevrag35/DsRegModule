...
namespace MG.DsReg
{
    ...
    public class SSOState : BaseDetail
    {
        ...
        [JsonIgnore]
        public DateTimeOffset? AzureAdPrimaryRefreshTokenExpiryTime => base.ConvertTime(this.azureadprtExpiryTime);

        [JsonIgnore]
        public DateTimeOffset? AzureAdPrimaryRefreshTokenUpdateTime => base.ConvertTime(this.azureAdPrtUpdateTime);
